...
public class ShoppingLedgerTests
{
    ...
    {
        var ledger = Domain.ShoppingLedger.ShoppingLedger.Create(TestSamples.UserId);

        ledger.OwnerId.Should().Be(TestSamples.UserId);
    ...
    {
        var original = Domain.ShoppingLedger.ShoppingLedger.Create(TestSamples.UserId);
        ...
        var rebuilt = Domain.ShoppingLedger.ShoppingLedger.FromEvents(original.Id, TestSamples.UserId, events);
    ...
    public void FromSnapshot_ContinuesFromSnapshotState()
    {
        ...
        var rebuilt = Domain.ShoppingLedger.ShoppingLedger.FromSnapshot(
            original.Id, TestSamples.UserId, snapshotItems, 2, newEvents);
