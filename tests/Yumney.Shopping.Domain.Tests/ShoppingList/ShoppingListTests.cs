...
public class ShoppingListTests
{
    ...
    public void Create_ValidInput_SetsItems()
    {
        ...
        [
            ...
            ShoppingListItem.Create(ItemName.From("Sugar"), Quantity.From(200, Unit.Grams)),
        ];
        ...
        RecipeReference? recipeReference = null)
    {
        return Domain.ShoppingList.ShoppingList.Create(
            ...
            items ?? [ShoppingListItem.Create(ItemName.From("Flour"), Quantity.From(500, Unit.Grams))],
            recipeReference);
    }
}
