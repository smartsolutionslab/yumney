...
public class ShoppingListItemTests
{
    ...
    {
        var item = ShoppingListItem.Create(ItemName.From("Eggs"), Quantity.From(3, null));
    ...
    {
        var item = ShoppingListItem.Create(ItemName.From("Flour"), Quantity.From(500, Unit.Grams));
