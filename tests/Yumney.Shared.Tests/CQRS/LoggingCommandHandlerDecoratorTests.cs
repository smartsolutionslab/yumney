...
public class LoggingCommandHandlerDecoratorTests
{
    ...
    public async Task HandleAsync_Success_DelegatesAndReturnsResult()
    {
        ...
        var decorator = new LoggingCommandHandlerDecorator<TestCommand, Result<string>>(inner, logger);
    ...
    public async Task HandleAsync_NonResultType_TreatsAsSuccess()
    {
        ...
        var decorator = new LoggingCommandHandlerDecorator<PlainCommand, string>(plainInner, plainLogger);
