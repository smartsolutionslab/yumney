...
public class SaveRecipeCommandHandlerTests
{
    ...
    public async Task HandleAsync_ValidCommand_CreatesRecipeWithCorrectIngredients()
    {
        ...
        var command = new SaveRecipeCommand(
            ...
            [
                new SaveRecipeIngredientItem(IngredientName.From("Flour"), Quantity.From(500, Unit.Grams)),
                new SaveRecipeIngredientItem(IngredientName.From("Sugar"), Quantity.From(100, null)),
            ],
    ...
    private static SaveRecipeCommand CreateValidCommand()
    {
        return new SaveRecipeCommand(
            ...
            [new SaveRecipeIngredientItem(IngredientName.From("Spaghetti"), Quantity.From(400, Unit.Grams))],
